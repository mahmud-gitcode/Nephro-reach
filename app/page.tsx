...
import NephroReachLogo from "@/components/NephroReachLogo";
import AbstractSwirl from "@/components/AbstractSwirl";
            ...
            {!isSignUp ? (
              ...
              <div className="space-y-6">
                ...
                <form className="space-y-3.5" onSubmit={(e) => e.preventDefault()}>
                  ...
                  <div className="space-y-1">
                    ...
                    <div className="relative">
                      ...
                      <input
                        type="text"
                        placeholder="Example"
                        className="w-full pl-11 pr-4 py-2.5 bg-white border border-slate-200 rounded-xl outline-none focus:border-blue-500 focus:ring-4 focus:ring-blue-100 transition-all text-slate-800 text-sm font-medium shadow-sm placeholder:text-slate-400"
                      />
                    </div>
                  </div>
                  ...
                  <div className="space-y-1">
                    ...
                    <div className="relative">
                      ...
                      <input
                        type={showPassword ? "text" : "password"}
                        placeholder="at least 8 characters"
                        className="w-full pl-11 pr-10 py-2.5 bg-white border border-slate-200 rounded-xl outline-none focus:border-blue-500 focus:ring-4 focus:ring-blue-100 transition-all text-slate-800 text-sm font-medium shadow-sm placeholder:text-slate-400"
                      />
                      <button
                        type="button"
                        onClick={() => setShowPassword(!showPassword)}
                  ...
                  <div className="flex items-start gap-2.5 mt-2 bg-slate-50/60 p-3 rounded-lg border border-slate-100">
                    <input
                      type="checkbox"
                      id="hipaa-verify"
                      className="mt-1 w-4.5 h-4.5 text-blue-600 border-slate-300 rounded focus:ring-blue-500 focus:ring-2 focus:ring-offset-0 cursor-pointer"
                    />
                    <label htmlFor="hipaa-verify" className="text-[11px] text-slate-500 leading-relaxed select-none cursor-pointer">
                  ...
                  <button
                    type="submit"
                    className="w-full py-3 bg-[#2563EB] hover:bg-[#1D4ED8] active:bg-[#1E40AF] text-white font-semibold rounded-xl transition-all shadow-[0_4px_12px_rgba(37,99,235,0.2)] text-sm tracking-wide mt-2"
                  >
                    Sign in
                  </button>
                </form>
