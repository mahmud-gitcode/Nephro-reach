...
export default function AddDialysisTreatmentPage() {
  ...
  const handleSave = () => {
    router.push("/dashboard/personal-log/dialysis-treatment");
  };

  return (
    <div className="w-full flex justify-center py-4">
      <div className="flex flex-col w-full max-w-xl rounded-3xl bg-white shadow-xl border border-slate-200 overflow-hidden">
        {/* HEADER */}
        ...
        {/* FOOTER */}
        <div className="flex items-center justify-between gap-3 border-t border-slate-100 p-5 bg-[#F8FAFC]">
          <Link
            href="/dashboard/personal-log/dialysis-treatment"
            className="rounded-xl border border-slate-200 bg-white px-6 py-3 text-sm font-bold text-slate-700 hover:bg-slate-100 transition-colors shadow-2xs"
          >
            Cancel
          </Link>
          <button
