...
import { Phone, Pencil, ChevronRight } from "lucide-react";
  ...
  return (
    <div className="w-full space-y-6">
      ...
      <div className="flex justify-center py-4">
        {isEditing ? (
          /* EDIT MY RIDE FORM CARD */
          <div className="w-full max-w-md rounded-3xl bg-white p-6 text-left shadow-xl border border-slate-200 space-y-6">
            <div className="space-y-2">
              ...
              <input
                ...
                className="w-full rounded-2xl border border-slate-200 bg-white p-4 text-base font-medium text-slate-800 outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500"
          ...
          /* MAIN NEED A RIDE CARD */
          <div className="w-full max-w-md rounded-3xl bg-white p-6 text-center shadow-xl border border-slate-200 space-y-5">
            ...
            <div className="rounded-2xl border border-blue-100 bg-[#F4F8FF] p-4 text-left space-y-3 relative">
              <div className="flex items-center justify-between">
                <h2 className="text-base font-bold text-slate-900">My Ride</h2>
                <button
                  type="button"
