...
export const SKIP_DIRS = new Set([
  ...
  ".husky",
  ".vscode",
  /* Generated by tooling, not written by us. `.claude` in particular holds
     .cjs hook helpers, and linting those broke the whole run: the Next
     config registers the react-hooks plugin only for ts/tsx/js/jsx, so a
     .cjs file reached our rules block with no plugin behind it and ESLint
     failed to build a config at all. */
  ".claude",
  "graft",
  "node_modules",
  "out",
