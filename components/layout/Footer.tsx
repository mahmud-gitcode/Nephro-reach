...
export default function Footer() {
  return (
    <footer className="bg-slate-100/60 border-t border-slate-200/50 py-16 px-4 sm:px-6 lg:px-8">
      <div className="max-w-[1404px] mx-auto grid grid-cols-1 md:grid-cols-4 gap-12">
        ...
        <div className="space-y-4">
          <h4 className="text-sm font-bold text-slate-800 uppercase tracking-wider">Platform</h4>
          <ul className="space-y-2.5 text-sm text-slate-500 font-semibold">
      ...
      <div className="max-w-[1404px] mx-auto mt-12 pt-8 border-t border-slate-200/50 flex flex-col sm:flex-row items-center justify-between text-xs text-slate-400 font-semibold gap-4">
